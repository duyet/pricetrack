...
class SubscribeBox extends Component {
  ...
  handleChangeActive() {
    ...
    if ((!this.state.info.expect_price || parseInt(this.state.info.expect_price, 10) === 0)
          && this.props.data) stateInfo['expect_price'] = this.props.data.latest_price;
